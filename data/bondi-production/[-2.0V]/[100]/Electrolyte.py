...
def get_input_data(calculation_type: str = "scf") -> Dict[str, Any]:
    """
...
def prepare_slab(relaxed_bulk: Atoms) -> Atoms:
    ...
    """
    slab = read("/mnt/lustre/a2fs-nvme/work/e89/e89/ba3g18/bondi-production/[-2.0V]/[100]/espresso.pwo", index=-1)
    return slab
...
def main() -> None:
    ...
    slab_input_data = get_input_data("scf" if EXTERNAL else "scf")
    ...
    slab_input_data["electrons"].update(
        {
            ...
            "conv_thr": 1.0e-14 if EXTERNAL else 1.0e-14,  
            "diagonalization": "david",
        }
    )
